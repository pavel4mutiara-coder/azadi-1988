...
const NoticeItem = ({ notice, lang }: { notice: Notice; lang: Language }) => (
      ...
      >
        ...
        <div className="flex items-center">
          {activeNotices.map((notice) => (
            <NoticeItem key={`orig-${notice.id}`} notice={notice} lang={lang} />
          ))}
        </div>
        <div className="flex items-center">
          {activeNotices.map((notice) => (
            <NoticeItem key={`dup-${notice.id}`} notice={notice} lang={lang} />
          ))}
        </div>
      </div>
